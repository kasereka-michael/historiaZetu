...
/*
TODO
	Loop to occasionally generate a draft of wind force (WF)
		If a wind force is generated:
			Suspend loop until T time in the future
			Generate random WF value and duration
			Ease towards WF value from zero for % duration
			Remain at WF value for % duration
			Ease towards zero from WF value for % duration
*/
class Flake {
...
const intervalUpdate = 100000/ 1000; // 60 updates per second.

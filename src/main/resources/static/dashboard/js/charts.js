(function($) {
  ...
  setTimeout(function() {
    c3DonutChart.load({
      columns: [
        ["Male", 60, 55, 70, 65, 50, 75, 80, 45, 60, 55, 70, 65, 50, 75, 80, 45, 60, 55, 70, 65, 50, 75, 80, 45, 60, 55, 70, 65, 50, 75, 80, 45, 60, 55, 70, 65, 50, 75, 80, 45, 60, 55, 70, 65, 50, 75, 80, 45, 60, 55],
        ["Female", 40, 45, 30, 35, 50, 25, 20, 55, 40, 45, 30, 35, 50, 25, 20, 55, 40, 45, 30, 35, 50, 25, 20, 55, 40, 45, 30, 35, 50, 25, 20, 55, 40, 45, 30, 35, 50, 25, 20, 55, 40, 45, 30, 35, 50, 25, 20, 55, 40, 45],
      ]
    });
  }, 1500);
  setTimeout(function() {
